...
func NewSdn-FabricGnmiClient(conn *grpc.ClientConn) *GnmiClient {
...
func (c *GnmiClient) GetDhcpServer_Item(ctx context.Context, target string, 
key string,
...
func (c *GnmiClient) DeleteDhcpServer_Item(ctx context.Context, target string, 
key string,
...
func (c *GnmiClient) UpdateDhcpServer_Item(ctx context.Context, target string,  data OnfDhcpServer_DhcpServer,
) (*gnmi.SetResponse, error) {
    gnmiCtx, cancel := context.WithTimeout(ctx, 10*time.Second)
    defer cancel()
...
func (c *GnmiClient) GetRoute_Item(ctx context.Context, target string, 
key string,
...
func (c *GnmiClient) DeleteRoute_Item(ctx context.Context, target string, 
key string,
) (*gnmi.SetResponse, error) {
    gnmiCtx, cancel := context.WithTimeout(ctx, 10*time.Second)
    defer cancel()
...
func (c *GnmiClient) UpdateRoute_Item(ctx context.Context, target string,  data OnfRoute_Route,
) (*gnmi.SetResponse, error) {
    gnmiCtx, cancel := context.WithTimeout(ctx, 10*time.Second)
    defer cancel()
...
func (c *GnmiClient) GetSwitch_Item(ctx context.Context, target string, 
key string,
...
func (c *GnmiClient) DeleteSwitch_Item(ctx context.Context, target string, 
key string,
) (*gnmi.SetResponse, error) {
    gnmiCtx, cancel := context.WithTimeout(ctx, 10*time.Second)
    defer cancel()
...
func (c *GnmiClient) UpdateSwitch_Item(ctx context.Context, target string,  data OnfSwitch_Switch,
) (*gnmi.SetResponse, error) {
    gnmiCtx, cancel := context.WithTimeout(ctx, 10*time.Second)
    defer cancel()
...
func (c *GnmiClient) GetSwitchModel_Item(ctx context.Context, target string, 
key string,
...
func (c *GnmiClient) DeleteSwitchModel_Item(ctx context.Context, target string, 
key string,
) (*gnmi.SetResponse, error) {
    gnmiCtx, cancel := context.WithTimeout(ctx, 10*time.Second)
    defer cancel()
...
func (c *GnmiClient) UpdateSwitchModel_Item(ctx context.Context, target string,  data OnfSwitchModel_SwitchModel,
) (*gnmi.SetResponse, error) {
    gnmiCtx, cancel := context.WithTimeout(ctx, 10*time.Second)
    defer cancel()
...
func (c *GnmiClient) GetDhcpServer(ctx context.Context, target string, 
...
func (c *GnmiClient) DeleteDhcpServer(ctx context.Context, target string, 
) (*gnmi.SetResponse, error) {
    gnmiCtx, cancel := context.WithTimeout(ctx, 10*time.Second)
    defer cancel()
...
func (c *GnmiClient) UpdateDhcpServer(ctx context.Context, target string,  list map[string]*OnfDhcpServer_DhcpServer,
) (*gnmi.SetResponse, error) {
    gnmiCtx, cancel := context.WithTimeout(ctx, 10*time.Second)
    defer cancel()
...
func (c *GnmiClient) GetRoute(ctx context.Context, target string, 
...
func (c *GnmiClient) DeleteRoute(ctx context.Context, target string, 
) (*gnmi.SetResponse, error) {
    gnmiCtx, cancel := context.WithTimeout(ctx, 10*time.Second)
    defer cancel()
...
func (c *GnmiClient) UpdateRoute(ctx context.Context, target string,  list map[string]*OnfRoute_Route,
) (*gnmi.SetResponse, error) {
    gnmiCtx, cancel := context.WithTimeout(ctx, 10*time.Second)
    defer cancel()
...
func (c *GnmiClient) GetSwitch(ctx context.Context, target string, 
...
func (c *GnmiClient) DeleteSwitch(ctx context.Context, target string, 
) (*gnmi.SetResponse, error) {
    gnmiCtx, cancel := context.WithTimeout(ctx, 10*time.Second)
    defer cancel()
...
func (c *GnmiClient) UpdateSwitch(ctx context.Context, target string,  list map[string]*OnfSwitch_Switch,
) (*gnmi.SetResponse, error) {
    gnmiCtx, cancel := context.WithTimeout(ctx, 10*time.Second)
    defer cancel()
...
func (c *GnmiClient) GetSwitchModel(ctx context.Context, target string, 
...
func (c *GnmiClient) DeleteSwitchModel(ctx context.Context, target string, 
) (*gnmi.SetResponse, error) {
    gnmiCtx, cancel := context.WithTimeout(ctx, 10*time.Second)
    defer cancel()
...
func (c *GnmiClient) UpdateSwitchModel(ctx context.Context, target string,  list map[string]*OnfSwitchModel_SwitchModel,
) (*gnmi.SetResponse, error) {
    gnmiCtx, cancel := context.WithTimeout(ctx, 10*time.Second)
    defer cancel()
