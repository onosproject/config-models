...
set-testdevice-1.0.0-cont1a_list2a-2a-2.gnmi
set-testdevice-1.0.0-cont1a_list5-one-2.gnmi
set-testdevice-1.0.0-cont1a_list5-three-3.gnmi
set-testdevice-1.0.0-cont1a_list5-two-2.gnmi
set-testdevice-1.0.0-cont1a_list4-2a-1.gnmi
set-testdevice-1.0.0-cont1a_list4-2a-2.gnmi
)
