...
go run github.com/openconfig/ygot/generator -path=$OPENCORD/roc-helm-charts//config-models/aether-4.x/files/yang \
       -output_file=aether_4_0_0/generated.go -package_name=aether_4_0_0 -generate_fakeroot --include_descriptions\
...
lf=$'\n'; sed "${sedi[@]}" -e "1s/^/\/\/ Code generated by YGOT. DO NOT EDIT.\\$lf/" aether_4_0_0/generated.go
