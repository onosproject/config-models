...
go run github.com/openconfig/ygot/generator -path=../../../sdran-helm-charts/config-models/aether-2.x/files/yang \
       -output_file=aether_2_0_0/generated.go -package_name=aether_2_0_0 -generate_fakeroot \
