...
import (
	"fmt"
	"github.com/onosproject/onos-config/modelplugin/ric-1.0.0/ric_1_0_0"
...
var modelData = []*gnmi.ModelData{
    ...
    {Name:"o-ran-sc-ric-gnb-status-v1",Organization:"O-RAN Software Community",Version:"2020-01-29"},
    {Name:"o-ran-sc-ric-ueec-config-v1",Organization:"O-RAN Software Community",Version:"2020-01-29"},
}
